...
Route::get('/shop/{id}', [ItemController::class, 'shop_index']);
Route::get('/item/{id}', [ItemController::class, 'detail']);
Route::get('/search', [ItemController::class, 'search']);
Route::middleware('auth:web')->get('/sell', [ItemController::class, 'sell']);
Route::post('/sell', [ItemController::class, 'sell_register']);
Route::get('/sell/{id}', [ItemController::class, 'shop_sell']);
...
Route::post('/mypage/shop', [MypageController::class, 'shop']);
...
Route::prefix('master')->middleware('auth:masters')->group(function () {
